  ...
  return (
    <>
      <section class='flex justify-center relative'>
        ...
        <RiChatDeleteFill class='absolute top-20 xl:top-24 left-4 text-xl hover:text-green-700 cursor-pointer xl:text-2xl text-white' onClick={()=>navigate('/')}/>
      </section>
      <section class='bg-green-200 p-5 '>
        <ul class='font-bold font-serif flex flex-row justify-evenly text-sm md:text-lg xl:text-xl text-black'>
          <li>
            <div>Product</div>
          </li>
          <li>
