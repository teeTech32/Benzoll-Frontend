...
const Ticket = () => {
  ...
  <div class='container w-[450px] h-auto md:w-[600px] bg-[radial-gradient(circle_at_center,_var(--tw-gradient-stops))] from-gray-300 via-green-700 to-green-900 mx-20 my-28 py-5  rounded-t-xl rounded-bl-xl relative '>
    {showAlert && (
